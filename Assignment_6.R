...
#don't lie along a horizontal line roughly, but rather a negatively sloped line), it would be fair to say that linearity is lacking within the data. The
#'Normal Q-Q' plot tests normality of the data. the points lie closely along a straight line, and hence the normality assumption is satisfied by this
